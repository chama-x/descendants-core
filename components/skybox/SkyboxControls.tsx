  ...
  const handlePresetSelect = useCallback(
    async (presetId: string) => {
      try {
        ...
        const errorMessage =
          err instanceof Error ? err.message : "Failed to change skybox";
        ...
        {presetList.map((preset) => (
          ...
          >
            ...
            <div className="absolute top-2 right-2">
              ...
              ${
                preset.performance.quality === "high"
                  ? "bg-green-100 text-green-800"
                  : preset.performance.quality === "medium"
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center space-x-3">
            <Slider
              ...
              onValueChange={(value) =>
                handleConfigChange("transitionDuration", value[0])
              }
              max={3000}
              min={100}
              step={100}
          ...
          <div className="flex space-x-2">
            {(["performance", "balanced", "quality"] as const).map((mode) => (
              <Button
                key={mode}
                variant={
                  config.performanceMode === mode ? "default" : "outline"
                }
                size="sm"
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              handleConfigChange("enableAtmosphericEffects", checked)
            }
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              handleConfigChange("autoLoadNextSkybox", checked)
            }
          />
        </div>
        ...
        <div>
          ...
          <div className="flex items-center space-x-3">
            <Slider
              ...
              onValueChange={(value) =>
                handleConfigChange("maxCacheSize", value[0])
              }
              max={512}
              min={64}
              step={32}
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div className="space-y-1">
            ...
            <div
              className={`font-medium ${performance.frameImpact < -5 ? "text-red-500" : "text-green-500"}`}
            >
