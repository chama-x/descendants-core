...
export function MigrationHelper({
  ...
  const checkCompatibility = () => {
    ...
    if (blockMap.size > 1000) {
      warnings.push(`High block count (${blockMap.size}) - modular system will help with performance`);
    }

    if (simulants.size > 20) {
      warnings.push(`Many simulants (${simulants.size}) - LOD system will improve performance`);
    }
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl max-h-[90vh] overflow-auto">
        ...
        <div className="bg-blue-600 text-white p-4 rounded-t-lg">
          ...
          <p className="text-sm opacity-90">
            Current: <span className="font-semibold capitalize">{currentSystem} System</span>
          </p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded">
                ...
                {performanceData.legacy ? (
                  <div className="text-sm space-y-1">
                    <p>Avg Frame Time: {performanceData.legacy.averageFrameTime.toFixed(2)}ms</p>
                    <p>Memory Usage: {(performanceData.legacy.memoryUsage / 1024 / 1024).toFixed(1)}MB</p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded">
                <h4 className="font-medium text-green-600 mb-2">Modular System</h4>
                {performanceData.modular ? (
                  <div className="text-sm space-y-1">
                    <p>Avg Frame Time: {performanceData.modular.averageFrameTime.toFixed(2)}ms</p>
                    <p>Memory Usage: {(performanceData.modular.memoryUsage / 1024 / 1024).toFixed(1)}MB</p>
            ...
            >
              {isCollectingData ? 'Collecting Data...' : 'Collect Performance Data'}
            </button>
          </section>
          ...
          <section>
            ...
            {compatibility.warnings.length > 0 && (
              <div className="mb-4">
                <h4 className="font-medium text-yellow-600 mb-2">⚠️ Performance Warnings</h4>
                ...
                <div className="space-y-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Your world data is preserved automatically. No manual backup needed.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      The modular system will automatically detect your performance needs and configure modules accordingly.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Use the performance preset selector (AUTO/HIGH_PERFORMANCE/BALANCED/LOW_END) to optimize for your device.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Enable/disable individual modules as needed. Animation and block placement modules can be toggled independently.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Enable performance monitoring to see real-time stats for each module and system-wide performance.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <table className="w-full text-sm border-collapse border border-gray-300 dark:border-gray-600">
                <thead>
                  <tr className="bg-gray-100 dark:bg-gray-700">
                    <th className="border border-gray-300 dark:border-gray-600 p-2 text-left">Feature</th>
                    <th className="border border-gray-300 dark:border-gray-600 p-2 text-left">Legacy System</th>
                    <th className="border border-gray-300 dark:border-gray-600 p-2 text-left">Modular System</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-600 p-2 font-medium">Render Loop</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Single shared loop</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Isolated per module</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-600 p-2 font-medium">Performance</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Cross-system interference</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Independent optimization</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-600 p-2 font-medium">Animation LOD</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Basic</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Advanced distance-based</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-600 p-2 font-medium">Block Placement</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Direct operations</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Debounced & batched</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 dark:border-gray-600 p-2 font-medium">Monitoring</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Basic FPS counter</td>
                    <td className="border border-gray-300 dark:border-gray-600 p-2">Per-module statistics</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-b-lg flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <button
              onClick={currentSystem === 'legacy' ? onSwitchToLegacy : onSwitchToModular}
            ...
            <button
              onClick={currentSystem === 'legacy' ? onSwitchToModular : onSwitchToLegacy}
...
export const MigrationUtils = {
  ...
  checkModularCompatibility: (blockCount: number, simulantCount: number) => {
    ...
    if (blockCount > 2000) {
      compatibility.warnings.push('Very high block count - consider using LOW_END preset');
    }

    if (simulantCount > 50) {
      compatibility.warnings.push('High simulant count - LOD system will be essential');
    }

    if (blockCount > 500) {
      compatibility.recommendations.push('Enable block batching for better performance');
    }

    if (simulantCount > 10) {
      compatibility.recommendations.push('Use BALANCED or LOW_END preset for smoother animations');
    }
  ...
  exportWorldState: (blockMap: Map<string, any>, simulants: Map<string, any>) => {
    return {
