...
export default function BasicAnimationTest() {
  ...
  // Debug logging
  useEffect(() => {
    console.log("🧪 Basic Animation Test - Avatar GLTF:", avatarGLTF);
    console.log("🧪 Basic Animation Test - Walk GLTF:", walkGLTF);
    console.log("🧪 Basic Animation Test - T-pose GLTF:", tposeGLTF);
    console.log("🧪 Basic Animation Test - All animations:", allAnimations);
    console.log("🧪 Basic Animation Test - Actions:", actions);
    console.log("🧪 Basic Animation Test - Available action names:", Object.keys(actions));
  ...
  useEffect(() => {
    ...
    if (actionNames.length > 0) {
      ...
      if (firstAction) {
        console.log(`🎬 Playing first available animation: ${actionNames[0]}`);
        firstAction.play();
      }
    }
  }, [actions]);
