...
export const ARCHIPELAGO_PRESETS: Record<string, ArchipelagoPreset> = {
  ...
  tropical_paradise: {
    ...
    description:
      "Lush tropical islands in a perfect circle, ideal for vacation vibes",
    category: "tropical",
    difficulty: "easy",
  ...
  fire_ring: {
    ...
    name: "🌋 Ring of Fire",
    description:
      "Volcanic islands forming a dramatic ring around a central lagoon",
    category: "volcanic",
    difficulty: "medium",
    recommendedGridSize: 320,
  ...
  continental_drift: {
    ...
    description:
      "Massive island continents with varied biomes - requires large grid",
    category: "fantasy",
    difficulty: "complex",
...
export function getPresetsByCategory(
  ...
  return Object.values(ARCHIPELAGO_PRESETS).filter(
...
export function getPresetsByTag(tag: string): ArchipelagoPreset[] {
  return Object.values(ARCHIPELAGO_PRESETS).filter((preset) =>
