...
export const PerformanceBenchmark: React.FC<PerformanceBenchmarkProps> = ({
  ...
  const benchmarkTests = [
    {
      name: "Basic Floor Rendering",
      description: "Test basic floor rendering performance",
    },
    {
      name: "Multiple Floors",
      description: "Test performance with many floors",
    },
    {
      name: "Transparency Effects",
      description: "Test transparency rendering overhead",
    },
    {
      name: "LOD System",
      description: "Test level of detail performance impact",
    },
    {
      name: "AI Navigation",
      description: "Test AI navigation system performance",
    },
    {
      name: "Advanced Effects",
      description: "Test caustics and reflection performance",
    },
  ];
  ...
  return (
    <div
      className={`performance-benchmark ${className}`}
      style={{
        position: "fixed",
        top: "50%",
        left: "50%",
          ...
          <div style={{ padding: "15px" }}>
            ...
            {results.map((result, index) => (
              ...
              >
                ...
                <div
                  style={{ color: getFPSColor(result.fps), fontWeight: "600" }}
                >
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                {(
                  results.reduce((sum, r) => sum + r.frameTime, 0) /
                  results.length
                ).toFixed(1)}
                ms
              </div>
