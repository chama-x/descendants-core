...
export default function Robot({ controller = useRobotController, groupRef: externalRef }: { controller?: typeof useRobotController, groupRef?: React.RefObject<THREE.Group | null> }) {
    ...
    const { bodyMat, jointMat, glowMat } = useMemo(() => {
        ...
        return { bodyMat: mats.robotBody, jointMat: mats.robotJoint, glowMat: mats.robotGlow };
    }, []);

    return (
        <group ref={groupRef} position={[0, 5, -330]}>
