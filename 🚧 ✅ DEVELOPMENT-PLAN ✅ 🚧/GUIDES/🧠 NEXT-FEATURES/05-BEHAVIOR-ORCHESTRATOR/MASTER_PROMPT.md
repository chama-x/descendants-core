...
------------------------------------------------------------
"""
Feature: F05-BEHAVIOR-ORCHESTRATOR
Sub-Task: <NAME>
Context:
...
2. Generate 20 sub-prompts (Section 13).  
...
- COUNT=20
- All contain "Feature: F05-BEHAVIOR-ORCHESTRATOR"
